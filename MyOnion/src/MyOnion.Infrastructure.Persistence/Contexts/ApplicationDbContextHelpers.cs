internal static class ApplicationDbContextHelpers
{
    ...
    public static void DatabaseModelCreating(ModelBuilder modelBuilder)
    {
        ...
        var departmentNameConverter = new ValueConverter<DepartmentName, string>(
            name => name.Value,
            value => new DepartmentName(value));

        var positionTitleConverter = new ValueConverter<PositionTitle, string>(
            title => title.Value,
            value => new PositionTitle(value));
        ...
        modelBuilder.Entity<Department>(entity =>
        {
            ...
            entity.Property(e => e.Name)
                ...
                .HasMaxLength(250)
                .IsRequired(); // Required and maximum length of Name property
        ...
        modelBuilder.Entity<Position>(entity =>
        {
            ...
            entity.Property(e => e.PositionTitle)
                .HasConversion(positionTitleConverter)
                .IsRequired()
                .HasMaxLength(250); // Required and maximum length of PositionTitle property
            entity.HasIndex(e => e.PositionTitle).IsUnique();
